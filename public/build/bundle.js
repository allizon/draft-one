...
var app = (function () {
    ...
    const PENDING = Symbol("stopped");
    const STARTED = Symbol("started");
    const PAUSED = Symbol("paused");
    const DONE = Symbol("done");

    const editorState = writable(PENDING);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$2, 38, 4, 662);
    			add_location(button1, file$2, 39, 4, 722);
    			add_location(button2, file$2, 40, 4, 754);
    			attr_dev(div0, "class", "is-centered");
    			add_location(div0, file$2, 37, 2, 632);
    			attr_dev(textarea, "name", "");
    			attr_dev(textarea, "id", "");
    			attr_dev(textarea, "cols", "30");
    			attr_dev(textarea, "rows", "10");
    			textarea.value = editorState;
    			attr_dev(textarea, "class", "svelte-1nu2c7m");
    			add_location(textarea, file$2, 42, 2, 791);
    			attr_dev(div1, "class", "block column");
    			add_location(div1, file$2, 36, 0, 603);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button0, "click", /*setEditorState*/ ctx[1], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*getLabel*/ 1 && t0_value !== (t0_value = /*getLabel*/ ctx[0]() + "")) set_data_dev(t0, t0_value);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("getLabel" in $$props) $$invalidate(0, getLabel = $$props.getLabel);
    	};
    	...
    	return [getLabel, setEditorState];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			span0 = element("span");
    			span0.textContent = "Word Count:";
    			t1 = space();
    			span1 = element("span");
    			span1.textContent = "Elapsed Time:";
    			attr_dev(span0, "class", "wc svelte-1qyry5m");
    			add_location(span0, file$1, 3, 4, 49);
    			attr_dev(span1, "class", "time svelte-1qyry5m");
    			add_location(span1, file$1, 4, 4, 89);
    			attr_dev(div, "class", "column grid svelte-1qyry5m");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			header.textContent = "Draft One v2304";
    			t2 = space();
    			div1 = element("div");
    			div0 = element("div");
    			...
    			footer.textContent = "footer go here";
    			document.title = "Draft One v2304";
    			attr_dev(header, "class", "svelte-1f1bv3s");
    			add_location(header, file, 10, 2, 170);
    			attr_dev(div0, "class", "column is-two-thirds");
    			add_location(div0, file, 12, 4, 243);
    			attr_dev(div1, "class", "columns is-centered");
    			add_location(div1, file, 11, 2, 205);
    			add_location(footer, file, 17, 2, 333);
    			attr_dev(main, "class", "svelte-1f1bv3s");
    			add_location(main, file, 9, 0, 161);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Editor, Stats });
    	return [];
    }
